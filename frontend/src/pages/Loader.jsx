...
// Pure CSS styles are defined as a string template literal
const pureCssStyles = `
  /* Must use generic class names as this is injected CSS */
  .full-screen-overlay {
    position: fixed;
    top: 0;
    left: 0;
  ...
  .loader-wrapper {
    ...
    margin: 2rem;
    z-index: 10000;
    font-family: "Inter", sans-serif; /* Using available font */
    font-size: 1.6em;
    font-weight: 600;
    user-select: none;
    color: #fff;
    transform: scale(2); /* Using transform for scale equivalent */
  }
